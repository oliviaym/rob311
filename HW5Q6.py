...
if __name__ == "__main__":
    ...
    for t in SoftRealtimeLoop(dt=DT, report=True):
        ...
        Tx = KP_THETA_X * error_x + KD_PHI_X * error_phi_x #+ KD_THETA_X * DT * (error_x-error_x_prev)
        Ty = KP_THETA_Y * error_y + KD_PHI_Y * error_phi_y #+ KD_THETA_Y * DT * (error_y-error_y_prev)
