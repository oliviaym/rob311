...
if __name__ == "__main__":
    ...
    pulse_controller = {'names': ['pulse','Tx'],
    ...
    for t in SoftRealtimeLoop(dt=DT, report=True):
        ...
        if loop_ct % 2 == 0:
            Tx = KP_THETA_X * error_x + KI_THETA_X * error_x_sum + KD_THETA_X * DT * (error_x-error_x_prev)
        else:
            Tx = KP_THETA_X * error_x + KI_THETA_X * error_x_sum + KD_THETA_X * DT * (error_x-error_x_prev) + pulse_val

        Ty = KP_THETA_Y * error_y + KI_THETA_Y * error_y_sum + KD_THETA_X * DT * (error_x-error_x_prev)
        ...
        print("Iteration no. {}, THETA X: {:.2f}, THETA Y: {:.2f}, PULSE: {}, T_NOW:{}, LOOP CT: {}, REMAINDER:{}, RESULT:{}".format(i, theta_x, theta_y, pulse_val, t_now, loop_ct,t_now % 0.2<= 0.0001,loop_ct % 2 == 0))
